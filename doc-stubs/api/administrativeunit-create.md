...
-->
``` http
POST ** Collection URI for microsoft.education.rostering.api.administrativeUnit not found
```
...
-->
``` http
POST https://graph.microsoft.com/v1.0** Collection URI for microsoft.education.rostering.api.administrativeUnit not found
