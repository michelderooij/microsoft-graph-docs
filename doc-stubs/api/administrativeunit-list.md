...
-->
``` http
GET ** Collection URI for microsoft.education.rostering.api.administrativeUnit not found
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0** Collection URI for microsoft.education.rostering.api.administrativeUnit not found
```
